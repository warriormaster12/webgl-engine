...
const _: () = assert!(
    std::mem::size_of:: < Material > () == 16, "size of Material does not match WGSL"
);
const _: () = assert!(
    memoffset::offset_of!(Material, color) == 0,
    "offset of Material.color does not match WGSL"
);
pub mod bind_groups {
